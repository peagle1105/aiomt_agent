...
@tool
def devices_check(url: Optional[str] = None) -> str:
    """
    ...
    """
    if url == None:
        url = 'https://iomt.hoangphucthanh.vn:3030/iot'
...
@tool    
def environment_check(url: Optional[str] = None) -> str:
    """
    ...
    """
    if url == None:
        url = 'https://iomt.hoangphucthanh.vn:3030/iot/iot-env/latest'
...
@tool
def leakage_current_check(url: Optional[str] = None) -> str:
    """
